...
namespace Graphics1 {
	...
	// рабочие вспомогательные переменные
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->btnOpen->Location = System::Drawing::Point(590, 19);
			this->btnOpen->Name = L"btnOpen";
			this->btnOpen->Size = System::Drawing::Size(55, 34);
...
#pragma endregion
	...
	private: System::Void MyForm_KeyDown(System::Object^  sender, System::Windows::Forms::KeyEventArgs^  e) {
		...
		case Keys::W:
			...
			break;
		case Keys::S:
			if (Control::ModifierKeys == Keys::Shift) { // TODO
		...
		case Keys::Z:
			if (Control::ModifierKeys == Keys::Shift) {
				...
				fovy_work = min(fovy_work + 0.2, 3.0);
			}
			break;
		case Keys::X:
			if (Control::ModifierKeys == Keys::Shift) {
